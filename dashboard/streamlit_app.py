...
A production-ready dashboard for deployment on Streamlit Cloud.
This version includes database integration and ML predictions.
"""
...
if df.empty:
    ...
    st.info("If you're seeing this on Streamlit Cloud, the data files may not be included in the deployment.")
    st.stop()

# Header with database status
db_status = "✅ Database Connected" if get_database() is not None else "📁 Using CSV Data"
